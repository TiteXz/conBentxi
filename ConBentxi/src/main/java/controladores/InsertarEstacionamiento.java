...
/**
 * Servlet implementation class InsertarEstacionamiento
 */
@WebServlet("/InsertarEstacionamiento")
public class InsertarEstacionamiento extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertarEstacionamiento() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		mE.Conectar();
		mE.ainadirEstacionamiento(estacionamiento);
		mE.cerrar();
