...
<body>
	...
	<P id="tituloCrucero">cruceros / actividades</P>

	<div id="logout"> <a href="AbrirLogin">Log out</a></div>

	<ul id="menu">
		<li><a href="VerCrucerosActividades" title="VISTAS">VISTAS </a></li>
	</ul>
	...
	<nav>
		<ul>
			<li><a>
					<div id="formulario">
						<form method="POST" action="InsertarCruceroActividad">
							<label><input required="required" type="number" id="id_crucero"
								name="id_crucero" placeholder="id_crucero" /></label> <br> <br>
							<label><input required="required" type="number" id="id_actividad"
								name="id_actividad" placeholder="id_actividad" /></label> <br> <br>
