			...
			<li><a>
					<div id="formulario">
						<form method="POST" action="InsertarCliente">
							<label><input
								required="required" type="text" id="dni" name="dni" placeholder="dni" /></label>
							<label><input
								required="required" type="text" id="nombre" name="nombre" placeholder="nombre" /></label> <br>
							<br> <label><input required="required" type="text" id="apellido"
								name="apellido" placeholder="apellido" /></label> <br> <br> 
							<div class="form-group">
			                    <div class="form-check">
			                        <label class="form-check-label" for="gridCheck"> +18 </label>
			                        <input class="form-check-input" name="mayor_edad" type="checkbox" id="mas18">
			                    </div>
			                </div>
								<br>
							<label><input required="required" type="number" id="num_tarjeta"
								name="num_tarjeta" placeholder="numero de tarjeta" /></label> <br> <br>
