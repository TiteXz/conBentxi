			...
			<li><a>
					<div id="formulario">
						<form method="POST" action="ModificarActividad">
							<label>Id actividad: <input readonly type="number" id="id_actividad" name="id_actividad" value="${actividad.id_actividad}" /></label>
							<label>Nombre: <input type="text" id="nombre" name="nombre" value="${actividad.nombre}" /></label> 
							<br>
							<br> 
							<label>Fecha inicio: <input type="date" id="fecha_ini" name="fecha_ini" value="${actividad.fecha_ini}"/></label>
								 <br> <br> <label>Fecha fin:<input
								type="date" id="fecha_fin" name="fecha_fin" value="${actividad.fecha_fin}"/></label> <br>
							<br> <label>Descripción: <input type="text" id="descripcion"
								name="descripcion" value="${actividad.descripcion}" /></label> <br> <br>
							<label>Id empleado: <input type="number" id="id_empleado"
								name="id_empleado" value="${actividad.id_empleado}" /></label> <br> <br>
