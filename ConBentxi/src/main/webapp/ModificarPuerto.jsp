...
<body>
	...
	<P id="tituloActividad">puertos</P>
	...
	<nav>
		<ul>
			<li><a>
					<div id="formulario">
						<form method="POST" action="ModificarPuerto">
							<label>Id puerto: <input readonly type="number" id="id_puerto" name="id_puerto" value="${puerto.id_puerto}" /></label>
							<br>
							<br>
							<label>Pais: <input type="text" id="pais" name="pais" value="${puerto.pais}"/></label>
							<br>
							<br> 
							<label>Ciudad: <input type="text" id="ciudad" name="ciudad" value="${puerto.ciudad}" /></label> 
							<br>
							<br> 
							<label>Amarre:<input type="number" id="amarre" name="amarre" value="${puerto.amarre}"/></label>
							<br>
							<br>
