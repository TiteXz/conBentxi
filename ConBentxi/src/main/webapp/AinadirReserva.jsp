...
<body>
	...
	<P id="tituloPuerto">reservas</P>

	<div id="logout"> <a href="AbrirLogin">Log out</a></div>

	<ul id="menu">
		<li><a href="VerReservas" title="VISTAS">VISTAS </a></li>
	</ul>
			...
			<li><a>
					<div id="formulario">
						<form method="POST" action="InsertarReserva">
							<label><input required="required" type="text" id="dni_cliente" name="dni_cliente"
								placeholder="dni_cliente" /></label> <br> <br> <label><input required="required"
								type="number" id="id_crucero" name="id_crucero" placeholder="id_crucero" /></label> <br>
							<br> <label><input required="required" type="date" id="fecha_ini"
