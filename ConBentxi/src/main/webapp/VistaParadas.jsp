...
<body>
	...
	<div id="wrapper">
		...
		<ul id="menu">
			<li><a href="AinadirParadas.jsp" title="CREAR">CREAR</a></li>
		...
		<table id="keywords" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					<th><span>id_parada</span></th>
					<th><span>ciudad</span></th>
					<th><span>pais</span></th>
					<th><span>tiempo_estacionamiento</span></th>
					<th><span>fecha_salida</span></th>
					<th><span>fecha_llegada</span></th>
					<th><span></span></th>
					<th><span></span></th>
				</tr>
			</thead>
			<tbody>
	  <c:forEach items="${paradas}" var="paradas">
	    <tr>
	      <th scope="row">${paradas.id_parada}</th>
	      <td>${paradas.ciudad}</td>
	      <td>${paradas.pais}</td>
	      <td>${paradas.tiempo_estacionamiento}</td>
	      <td>${paradas.fecha_salida}</td>
	      <td>${paradas.fecha_llegada}</td>
	      <td><a class= "eliminar" href="EliminarParada?id_parada=${paradas.id_parada}">Eliminar </a> </td>
	      <td><a class= "modificar" href="FormularioParada?id_parada=${paradas.id_parada}">Modificar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
