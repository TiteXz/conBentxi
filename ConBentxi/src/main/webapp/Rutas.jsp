...
<body>
 ...
 <div class="menu">
  ...
  <div class="input-container">
    <input placeholder="Busca tu Destino" class="input-field" type="text">
  ...
  <div class="card" style="width: 80rem;">
    <div class="card-body">
      <h5 class="card-title">Destino Córcega</h5>
      <h6 class="card-subtitle mb-2 text-muted">Origen Valencia</h6>
      <p class="card-text">El crucero es el Royal Mary el viaje es de 10 días.</p>
      <div class="scene">
        <div class="cube">
          <span class="side top"><a href="ReservarRuta.html">Reservar</a></span>
          <span class="side front">399.9</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="card" style="width: 80rem;">
    <div class="card-body">
      ...
      <div class="scene">
        <div class="cube">
          <span class="side top"><a href="ReservarRuta.html">Reservar</a></span>
          <span class="side front">799.9</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <footer class="footer">
    ...
    <p>&copy;2023 Iker Benat | All Rights Reserved</p>
  </footer>
