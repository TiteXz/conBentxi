...
<body>
	...
	<div id="wrapper">
		...
		<ul id="menu">
			<li><a href="AinadirHabitacion.jsp" title="CREAR">CREAR</a></li>
	  ...
	  <c:forEach items="${habitaciones}" var="habitacion">
	    <tr>
	      <th scope="row">${habitacion.numero_habitacion}</th>
	      <td>${habitacion.descripcion}</td>
	      <td>${habitacion.precio}</td>
	      <td>${habitacion.id_crucero}</td>
	      <td>${habitacion.dni_cliente}</td>
	      <td>${habitacion.id_empleado}</td>
	      <td>${habitacion.imagen}</td>
	      <td><a class= "eliminar" href="EliminarHabitacion?numero_habitacion=${habitacion.numero_habitacion}">Eliminar </a> </td>
	      <td><a class= "modificar" href="FormularioHabitacion?numero_habitacion=${habitacion.numero_habitacion}">Modificar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
