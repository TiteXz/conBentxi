...
<body>
	...
	<P id="tituloCrucero">rutas / paradas</P>

	<div id="logout"> <a href="AbrirLogin">Log out</a></div>

	<ul id="menu">
		<li><a href="VerRutasParadas" title="VISTAS">VISTAS </a></li>
	</ul>
	...
	<nav>
		<ul>
			<li><a>
					<div id="formulario">
						<form method="POST" action="InsertarRutaParada">
							<label><input required="required" type="number" id="id_ruta"
								name="id_ruta" placeholder="id_ruta" /></label> <br> <br>
							<label><input required="required" type="number" id="id_parada"
