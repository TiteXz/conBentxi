...
<body>
	...
	<div id="wrapper">
		...
		<ul id="menu">
			<li><a href="AinadirCliente.jsp" title="CREAR">CREAR</a></li>
		...
		<table id="keywords" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					...
					<th><span>mayor de edad</span></th>
					<th><span>numero tarjeta</span></th>
					<th><span></span></th>
					<th><span></span></th>
				</tr>
			</thead>
	  ...
	  <c:forEach items="${clientes}" var="clientes">
	    <tr>
	      ...
	      <td>${clientes.mayor_edad}</td>
	      <td>${clientes.num_tarjeta}</td>
	      <td><a class= "eliminar" href="EliminarCliente?dni=${clientes.dni}">Eliminar </a> </td>
	      <td><a class= "modificar" href="FormularioCliente?dni=${clientes.dni}">Modificar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
