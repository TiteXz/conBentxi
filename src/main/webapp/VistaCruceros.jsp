...
<body>
	...
	<div id="wrapper">
		...
		<table id="keywords" cellspacing="0" cellpadding="0">
			...
			<tbody>
	  <c:forEach items="${cruceros}" var="cruceros">
	    <tr>
	      <th scope="row">${cruceros.id_crucero}</th>
	      <td>${cruceros.nombre}</td>
	      <td>${cruceros.capitan}</td>
	      <td>${cruceros.categoria}</td>
	      <td>${cruceros.id_ruta}</td>
	      <td><a class= "eliminar" href="EliminarCrucero?id_crucero=${cruceros.id_crucero}">Eliminar </a> </td>
	      <td><a class= "modificar" href="FormularioCrucero?id_crucero=${cruceros.id_crucero}">Modificar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
