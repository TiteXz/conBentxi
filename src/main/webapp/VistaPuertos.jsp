...
<body>
	...
	<div id="wrapper">
		...
		<ul id="menu">
			<li><a href="AinadirPuerto.jsp" title="CREAR">CREAR</a></li>
		...
		<table id="keywords" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					...
					<th><span>amarre</span></th>
					<th><span></span></th>
					<th><span></span></th>
				</tr>
			</thead>
			<tbody>
	  <c:forEach items="${puertos}" var="puertos">
	    <tr>
	      <th scope="row">${puertos.id_puerto}</th>
	      <td>${puertos.pais}</td>
	      <td>${puertos.ciudad}</td>
	      <td>${puertos.amarre}</td>
	      <td><a class= "eliminar" href="EliminarPuerto?id_puerto=${puertos.id_puerto}">Eliminar </a> </td>
	      <td><a class= "modificar" href="FormularioPuerto?id_puerto=${puertos.id_puerto}">Modificar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
