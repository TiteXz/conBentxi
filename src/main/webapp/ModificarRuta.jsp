...
<body>
	...
	<nav>
		<ul>
			<li><a>
					<div id="formulario">
						<form method="POST" action="ModificarRuta">
							<label>Id ruta: <input readonly type="number" id="id_ruta" name="id_ruta" value="${ruta.id_ruta}" /></label>
							<br>
							<br>
							<label>Fecha inicio: <input type="date" id="fecha_ini" name="fecha_ini" value="${ruta.fecha_ini}"/></label>
							<br>
							<br> 
							<label>Fecha fin: <input type="date" id="fecha_fin" name="fecha_fin" value="${ruta.fecha_fin}" /></label> 
							<br>
							<br> 
							<label>Origen:<input type="text" id="origen" name="origen" value="${ruta.origen}"/></label>
							<br>
							<br>
							<label>Destino:<input type="text" id="destino" name="destino" value="${ruta.destino}"/></label>
							<br>
							<br>
