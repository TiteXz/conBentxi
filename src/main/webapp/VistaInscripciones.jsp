...
<body>
	...
	<div id="wrapper">
		...
		<ul id="menu">
			<li><a href="AinadirInscripcion.jsp" title="CREAR">CREAR</a></li>
		...
		<table id="keywords" cellspacing="0" cellpadding="0">
			...
			<tbody>
	  <c:forEach items="${inscripciones}" var="inscripciones">
	    <tr>
	      <th scope="row">${inscripciones.dni_cliente}</th>
	      <td>${inscripciones.id_actividad}</td>
	      <td><a class= "eliminar" href="EliminarInscripcion?dni_cliente=${inscripciones.dni_cliente}&id_actividad=${inscripciones.id_actividad}">Eliminar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
