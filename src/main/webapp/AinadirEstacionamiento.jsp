...
<title>Añadir Estacionamiento</title>
</head>
...
<body>
	...
	<P id="tituloCrucero">estacionamientos</P>
	
	<div id="logout"> <a href="AbrirLogin">Log out</a></div>

	<ul id="menu">
		<li><a href="VerEstacionamientos" title="VISTAS">VISTAS </a></li>
	</ul>
