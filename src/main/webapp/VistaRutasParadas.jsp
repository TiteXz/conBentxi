...
<body>
	...
	<div id="wrapper">
		...
		<ul id="menu">
			<li><a href="AinadirRutaParada.jsp" title="CREAR">CREAR</a></li>
		...
		<table id="keywords" cellspacing="0" cellpadding="0">
			...
			<tbody>
	  <c:forEach items="${rutasParadas}" var="rutasParadas">
	    <tr>
	      <th scope="row">${rutasParadas.id_ruta}</th>
	      <td>${rutasParadas.id_parada}</td>
	      <td><a class= "eliminar" href="EliminarRutaParada?id_ruta=${rutasParadas.id_ruta}&id_parada=${rutasParadas.id_parada}">Eliminar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
