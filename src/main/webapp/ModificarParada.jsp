...
<body>
	...
	<P id="tituloActividad">paradas</P>
	...
	<nav>
		<ul>
			<li><a>
					<div id="formulario">
						<form method="POST" action="ModificarParada">
							<label>Id parada: <input readonly type="number" id="id_parada" name="id_parada" value="${parada.id_parada}" /></label>
							<br>
							<br>
							<label>Ciudad: <input type="text" id="ciudad" name="ciudad" value="${parada.ciudad}" /></label> 
							<br>
							<br> 
							<label>Pais: <input type="text" id="pais" name="pais" value="${parada.pais}"/></label>
							<br>
							<br> 
							<label>Tiempo estacionado:<input type="number" id="tiempo_estacionamiento" name="tiempo_estacionamiento" value="${parada.tiempo_estacionamiento}"/></label>
							<br>
							<br>
							<label>Fecha salida: <input type="date" id="fecha_salida" name="fecha_salida" value="${parada.fecha_salida}" /></label>
							<br>
							<br>
							<label>Fecha llegada: <input type="date" id="fecha_llegada" name="fecha_llegada" value="${parada.fecha_llegada}" /></label>
							<br>
							<br>
