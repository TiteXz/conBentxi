...
<body>
	...
	<div id="wrapper">
		...
		<ul id="menu">
			<li><a href="AinadirActi.jsp" title="CREAR">CREAR</a></li>
	  ...
	  <c:forEach items="${actividades}" var="actividades">
	    <tr>
	      <th scope="row">${actividades.id_actividad}</th>
	      <td>${actividades.nombre}</td>
	      <td>${actividades.fecha_ini}</td>
	      <td>${actividades.fecha_fin}</td>
	      <td>${actividades.descripcion}</td>
	      <td>${actividades.id_empleado}</td>
	      <td><a class= "eliminar" href="EliminarActividad?id_actividad=${actividades.id_actividad}">Eliminar </a> </td>
	      <td><a class= "modificar" href="FormularioActividad?id_actividad=${actividades.id_actividad}">Modificar </a> </td>
	    </tr>
	  </c:forEach>
  </tbody>
		</table>
