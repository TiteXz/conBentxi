...
<title>Añadir Inscripcion</title>
</head>
...
<body>
	...
	<P id="tituloCrucero">inscripciones</P>

	<div id="logout"> <a href="AbrirLogin">Log out</a></div>

	<ul id="menu">
		<li><a href="VerInscripciones" title="VISTAS">VISTAS </a></li>
	</ul>
	...
	<nav>
		<ul>
			<li><a>
					<div id="formulario">
						<form method="POST" action="InsertarInscripcion">
