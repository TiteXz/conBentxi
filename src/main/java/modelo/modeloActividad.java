...
public class modeloActividad extends Conexion{
	...
	/**
	 * 
	 * @param actividad para insertarlo en la BBDD
	 */
	...
	/**
	 * 
	 * @param id_actividad para eliminar una actividad de la BBDD
	 */
	...
	/**
	 * 
	 * @param actividad con nuevos datos para modificar una actividad
	 */
	...
	/**
	 * 
	 * @param id_actividad para seleccionar una actividad de la BBDD
	 * @return la actividad seleccionada de la BBDD
	 */
