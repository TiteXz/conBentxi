...
public class modeloRuta extends Conexion{
	...
	/**
	 * 
	 * @param ruta para insertar una ruta en la BBDD
	 */
	...
	/**
	 * 
	 * @param id_ruta para eliminar una ruta de la BBDD
	 */
	...
	/**
	 * 
	 * @param destino para seleccionar las rutas que contengan la cadena de caracteres
	 * @return la lista de las rutas seleccionadas
	 */
	...
	/**
	 * 
	 * @param id_ruta para seleccionar una ruta
	...
	/**
	 * 
	 * @param ruta con datos nuevos para modificar una ruta
	 */
